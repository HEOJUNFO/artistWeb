...
const useHomeStore = create((set, get) => {
  const drums = createAudio('/audio/drums.mp3', { threshold: 10, expire: 500 })
  const snare = createAudio('/audio/snare.mp3', { threshold: 40, expire: 500 })
  const synth = createAudio('/audio/synth.mp3')
  return {
    loaded: false,
    clicked: false,
